...
const AdminDashboard: React.FC = () => {
  const { revenueData, isLoading, getRevenueData, generateRevenueReport } = useAdminRevenueStore();
    ...
    <AdminLayout>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-purple-800">Revenue Dashboard</h2>
          ...
          <div className="flex gap-4">
            ...
            <div className="relative">
              ...
              >
                <Calendar size={18} />
                {period === "year" ? "Past Year" : period === "month" ? "Past Month" : "All Time"}
                <ArrowDown size={16} />
              </button>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-medium text-gray-700 mb-4">Revenue by Plan</h3>
  ...
  <div className="h-64">
    ...
    >
      ...
      <Bar yAxisId="right" dataKey="count" name="Count" fill="#82ca9d" />
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {revenueData.recentTransactions.map((transaction) => (
                      <tr key={transaction.id}>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{transaction.hostName}</td>
          ...
          <div className="bg-white p-8 rounded shadow">
            <p className="text-gray-700">No revenue data available. Try changing the time period or check back later.</p>
          </div>
        )}
      </div>
    </AdminLayout>
