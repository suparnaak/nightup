...
import { Calendar, MapPin, Clock, Tag, User, Ticket, Eye } from 'lucide-react';
            ...
            <div key={event._id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/4 relative">
                  ...
                  />
                  <div className={`absolute top-3 right-3 ${event.isBlocked ? 'bg-red-500' : 'bg-green-500'} text-white text-sm font-bold px-3 py-1 rounded-full`}>
                    {event.isBlocked ? 'Cancelled' : 'Active'}
                  </div>
                </div>
                ...
                <div className="p-6 md:w-3/4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 mb-4">
                    ...
                    <div className="flex items-center text-gray-600">
                      <User size={18} className="text-purple-600 mr-2" />
                      <span>Host: {typeof event.hostId === 'object' && 'name' in event.hostId 
                        ? event.hostId.name 
                        : 'Unknown Host'}
                      </span>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {event.tickets.map((ticket, idx) => (
                          <div key={idx} className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm">
