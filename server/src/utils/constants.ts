...
export const CANCEL_REFUND = "Refund for event cancellation";
export const CANCEL_REASON = "Event Cancelled";
...
export const MESSAGES = {
  COMMON: {
    ...
    ERROR: {
      ...
      REQUIRED_PAYMENT_DATA:"Missing required payment verification data",
    },
  },
  ...
  USER: {
    SUCCESS: {
      ...
      NO_CANCEL:"Cannot cancel less than 24 hours before the event",
    },
    ERROR: {
  ...
  HOST: {
    SUCCESS: {
      ...
      EVENT_CANCELLED: (title: string, reason: string) =>
    `The event "${title}" has been cancelled. Reason: ${reason}. Your booking has been refunded.`,
      EVENT_UPDATED: (title: string) =>
    `The event "${title}" has been updated. Please visit your Bookings for the updated details`,
    },
    ERROR: {
      HOSTTYPE_REQUIRED: "Host type is required.",
      HOST_NOT_VERIFIED:
        "You are not allowed to add an event. Your account status does not permit this action.",
      DOCUMENT_NOT_VERIFIED:
        "You are not allowed to add an event. Your document is not verified by admin.",
      NO_SUBSCRIPTION:
        "You are not allowed to add an event. You don't have an active subscription.",
      MISSING_SUBSCRIPTION_FIELDS:
        "Missing required fields: planId, amount, or currentSubscriptionId",
      INVALID_SUBSCRIPTION: "Invalid subscription plan",
      UNAUTHORISED_SUBSCRIPTION:
      ...
      NOT_YOUR_SUBSCRIPTION_PLAN:
        "Unauthorized: This subscription does not belong to you",
        INVALID_DATE: "Invalid startTime for given date.",
        INVALID_END_TIME:"Invalid endTime for given date.",
        FAILED_CLOUDINARY_SIGNATURE:"Failed to generate signature",
        REQUIRED_CANCEL_REASON:"Cancellation reason is required.",
  ...
  ADMIN: {
    ...
    ERROR: {
      ...
      REQUIRED_CAT_NAME_DESC: "Category name and Description Required",
